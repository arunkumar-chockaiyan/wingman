        ...
        <div className="flex flex-col h-full bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
                <div className="flex items-center gap-2">
                    ...
                    <h2 className="font-bold text-slate-900 text-sm tracking-tight uppercase">Live Transcript</h2>
                </div>
                {isCalling && (
                    <div className="flex items-center gap-2 px-2 py-1 bg-indigo-50 rounded-md border border-indigo-100">
                        <span className="w-1.5 h-1.5 rounded-full bg-indigo-500 animate-pulse" />
                        <span className="text-[10px] font-bold text-indigo-600 uppercase tracking-wider">Syncing</span>
                    </div>
                )}
            </div>
                ...
                {transcripts.length === 0 ? (
                    <div className="h-full flex flex-col items-center justify-center opacity-30 text-center">
                        ...
                        <p className="text-sm font-medium text-slate-400 uppercase tracking-widest leading-loose">
                            Voice Processor Initialized...<br />
